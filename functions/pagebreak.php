...
function generatePageBar_cucreHome($page_prefix, $current_page, $page_size, $total_record, $url, $normal_class, $selected_class, $previous='<', $next='>', $first='<<', $last='>>', $break_type=1, $page_rewrite=0, $page_space=3, $obj_response='', $page_name="page"){
...
//			$href			= "javascript:;";
//			if($i != $current_page){
//				$page_bar .= ' <a href="' . $href . '" iPage = "' . $i . '" class="page_break ' . $normal_class . '">' . $i . '</a> ';
//			}
//			else{
//				$page_bar .= ' <a href="' . $href . '" iPage = "' . $i . '" class="page_break ' . $selected_class . '">' . $i . '</a> ';
//			}
//		}
//	}
