...
//gọi class DataGird
$list 				= new fsDataGird($id_field,$name_field,translate_text("Video Category"));
...
*/
$list->add("vid_images", translate_text("Ảnh"), "picture", 1, 0);
$list->add($name_field, translate_text("name"), "string", 0, 1);

$list->add("vid_active", translate_text("Active"),"checkbox", 1, 0);
