 ...
 */
  ...
  class Google_ProductsServiceResource extends Google_ServiceResource {
     ...
     * @opt_param bool categories.enabled Whether to return tintuc information
     ...
     * @opt_param string categories.include Category specification
     * @opt_param bool categories.useGcsConfig This parameter is currently ignored
     * @opt_param string categoryRecommendations.tintuc Category for which to retrieve recommendations
     * @opt_param bool categoryRecommendations.enabled Whether to return tintuc recommendation information
