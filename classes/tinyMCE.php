...
class tinyMCE{
	...
	*/
	...
	function tinyMCE($content, $text_area_id, $textarea_width="500", $textarea_height="300", $show_math=0){
		...
		$this->html_output .= '<script type="text/javascript" src="/js/tinyMCE/tiny_mce.js"></script>' . "\n";
		$this->html_output .= '
			<script type="text/javascript">
				...
				tinyMCE.init({
					...
					cleanup : true,
					language : "vi",
					plugins : "emotions, table' . $cleanupstyles_plugin . $math_plugin . '", ' . "\n" . 
					...
					theme_advanced_buttons2 : "image,link,unlink,emotions,|,table,tablecontrols,code' . $math_control . '",
