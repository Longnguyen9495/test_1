...
$url_redirect_login 	= urlencode('http://hanoimobile.com.vn/login_social.php?url_return=' . base64_url_encode($_SERVER['REQUEST_URI']));
...
$google_redirect_url		= 'http://hanoimobile.com.vn/login_google.php';
